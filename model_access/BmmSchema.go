...
type BmmSchema struct {
	...
	*/
	Includes map[string]vocabulary.IBmmIncludeSpec `yaml:"includes" json:"includes" xml:"includes"`
	...
	State vocabulary.BmmSchemaState `yaml:"state" json:"state" xml:"state"`
	/**
