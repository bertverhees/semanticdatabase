...
*/
func (i *BmmEnumerationBuilder) SetDocumentation(v map[any]string) *BmmEnumerationBuilder {
...
meta-model.
*/
func (i *BmmEnumerationBuilder) SetExtensions(v map[any]string) *BmmEnumerationBuilder {
