...
/**
	...
	populate_bmm_class_definition .
*/
func (i *PBmmEnumerationIntegerBuilder) SetBmmClass ( v vocabulary.IBmmEnumeration ) *PBmmEnumerationIntegerBuilder{
	i.pbmmenumerationinteger.BmmClass = v
	return i
}
	// //From: PBmmClass
...
/**
	...
	populate_bmm_class_definition .
*/
func (i *PBmmEnumerationIntegerBuilder) SetBmmClass ( v vocabulary.IBmmClass ) *PBmmEnumerationIntegerBuilder{
	i.pbmmenumerationinteger.BmmClass = v
	return i
}
/**
