...
/**
	...
	populate_bmm_class_definition .
*/
func (i *PBmmEnumerationStringBuilder) SetBmmClass ( v vocabulary.IBmmEnumeration ) *PBmmEnumerationStringBuilder{
	i.pbmmenumerationstring.BmmClass = v
	return i
}
	// //From: PBmmClass
...
/**
	...
	populate_bmm_class_definition .
*/
func (i *PBmmEnumerationStringBuilder) SetBmmClass ( v vocabulary.IBmmClass ) *PBmmEnumerationStringBuilder{
	i.pbmmenumerationstring.BmmClass = v
	return i
}
/**
